...
_DECLARED_CODES = {
    ...
    "PROTOCOL_REQUEST_CONFLICT": error_codes.PROTOCOL_REQUEST_CONFLICT,
    ...
    "MODEL_CAPACITY_EXCEEDED": error_codes.MODEL_CAPACITY_EXCEEDED,
    "REQUEST_NOT_FOUND": error_codes.REQUEST_NOT_FOUND,
}
